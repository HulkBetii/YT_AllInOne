...
def get(
    ...
    safe_mode: bool = typer.Option(True, "--safe-mode/--no-safe-mode", help="Increase request sleep/retries to reduce 429 and flakiness (default: enabled)"),
    user_agent: Optional[str] = typer.Option("Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:142.0) Gecko/20100101 Firefox/142.0", "--user-agent", help="Custom User-Agent header to mimic your browser"),
